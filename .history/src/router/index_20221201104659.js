...
import stars from '../views/userponent/stars.vue'
import followering from '../views/userponent/followering.vue'
import left from '../views/contentbar/left.vue'
import right from '../views/contentbar/right.vue'
import center from '../views/contentbar/center.vue'
...
const routes = [
    ...
    },
    {
        ...
        children: [
            { name: 'stars', path: '', component: stars },

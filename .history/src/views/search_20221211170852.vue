		...
		>
              <template #header>
                <div class="card-header">
                    <div class="texttitle">{{news.title}}</div>
                    <el-button class="button" text>
                        <el-icon><Star /></el-icon>
                    </el-button>
                </div>
            </template>
            <div  class="text item">{{ news.author}}</div>
			<!-- <div class="newsBox">
				<div class="newsText"> -->
